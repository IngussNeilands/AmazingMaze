...
config = {}
cmdline = ['C:/Marmalade/7.5/s3e/makefile_builder/mkb.py', 'd:/School/cs115/AmazingMaze/AmazingMaze.mkb', '--deploy-only', '--hub-data', 'D:/School/cs115/AmazingMaze/project_AmazingMaze/mkb-wp8.txt', '--buildenv=VC12', '--buildenv-toolset=WP8']
...
class DefaultConfig(DeployConfig):
    ...
    target = {
         'wp8-x86' : {
                   'debug'   : r'd:/School/cs115/AmazingMaze/build_amazingmaze_vc12_wp8toolset/Debug_AmazingMaze_VC12_WP8TOOLSET_x86/AmazingMaze.s86',
                   'release' : r'd:/School/cs115/AmazingMaze/build_amazingmaze_vc12_wp8toolset/Release_AmazingMaze_VC12_WP8TOOLSET_x86/AmazingMaze.s86',
                 },
         'wp8-arm' : {
                   'debug'   : r'd:/School/cs115/AmazingMaze/build_amazingmaze_vc12_wp8toolset/Debug_AmazingMaze_VC12_WP8TOOLSET_arm/AmazingMaze.s86',
                   'release' : r'd:/School/cs115/AmazingMaze/build_amazingmaze_vc12_wp8toolset/Release_AmazingMaze_VC12_WP8TOOLSET_arm/AmazingMaze.s86',
                 },
        }
    arm_arch = ''
