...
float level[8][15][11];  //a 3D arrway that stores the parent, door leftpt, blockpt, and childs					//0 = parent, 1 = leftpt, 2 = block, 3 = blockleft, 4 = blockright, 5 = childamount, 6-10 = childs
...
int main()
{
	...
	while (!s3eDeviceCheckQuitRequest())
	{
		...
		if (maze == 1){
			...
			//Iw2DDrawArc(CIwFVec2(surface_width / 2, surface_height / 2), CIwFVec2(15.0f, 15.0f), 0, 2 * PI);
			//Iw2DDrawArc(CIwFVec2(surface_width / 2, surface_height / 2), CIwFVec2(16.0f, 16.0f), 0, 2 * PI);
			//Iw2DDrawArc(CIwFVec2(surface_width / 2, surface_height / 2), CIwFVec2(17.0f, 17.0f), 0, 2 * PI);
			...
			//Iw2DDrawArc(CIwFVec2(surface_width / 2, surface_height / 2), CIwFVec2(30.0f, 30.0f), 0, 2 * PI);
			//Iw2DDrawArc(CIwFVec2(surface_width / 2, surface_height / 2), CIwFVec2(31.0f, 31.0f), 0, 2 * PI);
			//Iw2DDrawArc(CIwFVec2(surface_width / 2, surface_height / 2), CIwFVec2(32.0f, 32.0f), 0, 2 * PI);
			...
			//Iw2DDrawArc(CIwFVec2(surface_width / 2, surface_height / 2), CIwFVec2(45.0f, 45.0f), 0, 2 * PI);
			//Iw2DDrawArc(CIwFVec2(surface_width / 2, surface_height / 2), CIwFVec2(46.0f, 46.0f), 0, 2 * PI);
			//Iw2DDrawArc(CIwFVec2(surface_width / 2, surface_height / 2), CIwFVec2(47.0f, 47.0f), 0, 2 * PI);
			...
			//Iw2DDrawArc(CIwFVec2(surface_width / 2, surface_height / 2), CIwFVec2(15.0f, 15.0f), level[1][0][1], level[1][0][1] + 0.3);
			//Iw2DDrawArc(CIwFVec2(surface_width / 2, surface_height / 2), CIwFVec2(16.0f, 16.0f), level[1][0][1], level[1][0][1] + 0.3);
			//Iw2DDrawArc(CIwFVec2(surface_width / 2, surface_height / 2), CIwFVec2(17.0f, 17.0f), level[1][0][1], level[1][0][1] + 0.3);
			/*
			left[0] = 0.00001;
			right[0] = 0.3;


			Iw2DDrawArc(CIwFVec2(surface_width / 2, surface_height / 2), CIwFVec2(50.0f, 50.0f), 5, 2);
			Iw2DDrawArc(CIwFVec2(surface_width / 2, surface_height / 2), CIwFVec2(51.0f, 51.0f), 5, 2);
			Iw2DDrawArc(CIwFVec2(surface_width / 2, surface_height / 2), CIwFVec2(52.0f, 52.0f), 5, 2);
			left[1] = 5;
			right[1] = 5.2;
			...
			*/
			...
			for (int leveler = 1; leveler <= MaxLevel; leveler++){
				...
				for (int door = 0; door < 10; door++){
					...
					if (block > -1){
						if (printed == 0) printf("Max Level = %i [%i][%i][1]: leftpt = %f  block = %f parent = %f  childnm = %f blockleft = %f blockright = %f\n", 
						...
						float pt2x = ((leveler + 1) * 15) * sin(level[leveler][door][2]);
						float pt2y = ((leveler + 1) * 15) * cos(level[leveler][door][2]);
