...
s3e_plink -o "/Users/xiaolilillytang/Desktop/AmazingMaze/build_amazingmaze_xcode/build/${CONFIGURATION}${EFFECTIVE_PLATFORM_NAME}/AmazingMaze.s3e" --arch=armv8-a --compiler=gcc -u -d --usemap="/Users/xiaolilillytang/Desktop/AmazingMaze/build_amazingmaze_xcode/build/${CONFIGURATION}${EFFECTIVE_PLATFORM_NAME}/AmazingMaze.map" "${TARGET_BUILD_DIR}/${EXECUTABLE_NAME}"
